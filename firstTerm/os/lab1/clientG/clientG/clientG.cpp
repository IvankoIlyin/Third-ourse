...
void g(std::variant<os::lab1::compfuncs::hard_fail, os::lab1::compfuncs::soft_fail, double> &result,double x,bool &ready) {
    result= os::lab1::compfuncs::trial_g<os::lab1::compfuncs::DOUBLE_MULT>(x);
    ready = true;
}
...
string func(double x) {
    ...
    do {
        softFail = false;
        bool ready = false;
        std::thread threadF(g, std::ref(result), x, std::ref(ready));
        threadF.detach();
...
int main(int argc, char* argv[])
{
    ...
    const short SERVER_PORT_NUM = 1337;
