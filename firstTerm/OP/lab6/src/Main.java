...
public class Main {
    ...
    public static void main(String[] args) throws MPIException {
        ...
        double сannon = CannonAlgorithm(args, Size);
        double tape = TapeAlgorithm(Size, args);
        double standard = StandardAlgorithm(Size, args);

        System.out.println("Cannon algorithm: ");
        System.out.println("Size: "+Size+" time: "+standard+" ms");


        System.out.println("Tape algorithm: ");
        System.out.println("Size: "+Size+" time: "+tape+" ms");


        System.out.println("Standard algorithm: ");
        System.out.println("Size: "+Size+" time: "+сannon+" ms");
    }
}